...
export const READ_TOKEN_ID = "read the erc721 token id saved in the transaction {}";
export const READ_OWNER = "read the owner of the erc721 {} with token id {}";
export const READ_ASSET = "read the asset in the erc721 {} with token id {}";
