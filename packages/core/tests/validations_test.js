...
test("validateStartBlock works correctly if startBlock is not present", (t) => {
  ...
  t.is(
    error.message,
    "Please check your yml. Start (start:) is pointing nowhere!"
  );
});
...
test("validateNextBlock works correctly if nextBlock is not present", (t) => {
  ...
  t.is(
    error.message,
    "Please check your yml. Next (next:) is pointing nowhere for current block currentBlock!"
  );
});
...
test("validateIterable works correctly if forEachObject is not iterable", (t) => {
  ...
  t.is(
    error.message,
    "For each object with name:myList defined for the block: currentBlock is not an iterable object"
  );
});
...
test("validateForEach works correctly if forEachObject is null", (t) => {
  ...
  t.is(
    error.message,
    "For each object with name:myList defined for the block: currentBlock is null or undefined"
  );
});
